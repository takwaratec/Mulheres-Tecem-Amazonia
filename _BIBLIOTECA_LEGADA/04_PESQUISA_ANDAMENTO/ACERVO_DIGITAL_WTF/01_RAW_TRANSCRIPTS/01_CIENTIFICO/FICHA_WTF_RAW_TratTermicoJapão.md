...
referencia: PES-TEC-2487-2026
status: Ready

REFERÊNCIA BIBLIOGRÁFICA (ABNT):
RAMFUL, R.; SUNTHAR, T. P. M.; ZHU, W.; PEZZOTTI, G. Investigating the Underlying Effect of Thermal Modification on Shrinkage Behavior of Bamboo Culm by Experimental and Numerical Methods. **Materials**, Basel, v. 14, n. 974, 2021. Disponível em: https://doi.org/10.3390/ma14040974. Acesso em: 23 abr. 2024.
...
| Característica            | Valor/Intervalo                       | Notas                                                                 |
| :------------------------ | :------------------------------------ | :-------------------------------------------------------------------- |
| Temperatura de Retração   | 150 °C a 200 °C                       | Associada à perda de peso e aumento da dessorção de água              |
| Ciclo de Colheita (Bambu) | 4 a 5 anos                            | Metade do tempo da madeira macia de crescimento mais rápido           |
| Tipo de Material          | Biomaterial anisotrópico              | Bambu                                                                 |
| Método de Análise Química | FTIR (Espectroscopia de Infravermelho com Transformada de Fourier) | Monitoramento de variação química (celulose, hemicelulose, lignina) |
| Método Numérico           | FEM (Método de Elementos Finitos)     | Análise de concentração de deformação e indução de forças internas   |
