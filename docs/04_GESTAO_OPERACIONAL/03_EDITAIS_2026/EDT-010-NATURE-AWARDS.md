...
|---|---|---|---|
| **Dólar (USD)** | **US$ 50.000,00** | R$ 5,05 | **R$ 252.500,00** |

*Obs: Valor líquido para uso em despesas de projeto. Variação cambial instável devido ao cenário geopolítico; recomendo considerar margem de 5%.*
...
- **Critérios de Avaliação**:
    - Qualidade da pesquisa/iniciativa.
    - Impacto social e disseminação científica.
    - Promoção da diversidade e inclusão de mulheres em STEM.
...
|---|---|---|
| Protagonismo Feminino | ✅ Central (Mulheres que Tecem) | 100 |
| Ciência nas Fronteiras | ✅ Elevado (Bioeconomia na Amazônia) | 95 |
| Inovação e TRL | ✅ Tecnologias Sociais Aplicadas | 90 |
| Projeção Internacional | ✅ Excelente para o Consórcio | 95 |
| **Score Geral** | | **95/100** |

### Apontamentos Estratégicos (Curadoria)

O MQTF não é apenas um projeto de conservação; é uma iniciativa de **Ciência Soberana Liderada por Mulheres**. A candidatura da **Profª Tânia** (ou do Consórcio como entidade) deve enfatizar como a "ciência ancestral" das tecelãs e extrativistas está sendo codificada em protocolos de TRL elevado (5-9) para a bioeconomia de baixo carbono.

**Argumento Central**: "A transição ecológica da Amazônia não será feita por algoritmos, mas pelas mãos das mulheres que conhecem a resiliência da floresta."
...
|---|---|---|
| **Summary of Achievement** | Focar no impacto do Consórcio na dignidade das comunidades tradicionais e na produção científica de ponta da UnB/UFRR/UFAC. | 250 palavras |
| **Innovation/Methods** | Descrever a Balsa-Lab, o Domo-Fábrica e o Sistema de Bioarquitetura como inovações patenteáveis e aplicáveis. | 500 palavras |
| **Future Vision** | Expansão de rede para as Calhas de Rio (AM) e soberania de dados. | 300 palavras |
