...
referencia: ENG-MEM-T06_SOLDA-VEGETAL.md
status: Em Revisão
---
...
*   **Referência**: ENG-MEM-T06_SOLDA-VEGETAL.md
*   **Status**: Em Revisão

![Status: Em Revisão](https://img.shields.io/badge/Status-Em_Revisão-yellow)

# Memorial Técnico: Solda Vegetal (T06)
...
Refere-se a dispositivos de fixação e alinhamento espacial para a montagem de treliças e sistemas estruturais em bambu, especificamente para a técnica de **Solda Vegetal** (ancoragem química com biopolímeros).

### 1.2 Melhoria Funcional
A irregularidade geométrica natural dos colmos de bambu exige alinhamento preciso. O presente modelo introduz um **Gabarito Matricial com Grampos de Eixo Rotulado**.
...
2. **DISPOSIÇÃO**, de acordo com a reivindicação 1, caracterizada pelo sistema ser ancorado via **Sapatas de Base Metálicas**.
...
- <img src="../../../../assets/icons/human_07_black.svg" width="18px"> **ENG-NT-T06-01**: Memorial de Campo — Solda Vegetal em Variante Madeira.

## Como Citar
**APA:**
Takwara, F. R. (2026). *Memorial Jurídico: Solda Vegetal T06* (Versão 1.0 Mulheres que Tecem a Floresta). Projeto Mulheres Que Tecem a Floresta / Consórcio UnB/UFRR/UFAC. https://doi.org/10.5281/zenodo.18827106
