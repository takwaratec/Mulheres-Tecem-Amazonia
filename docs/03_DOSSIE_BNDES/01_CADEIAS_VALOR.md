...
## <img src="../assets/patterns/square_01_red.svg" width="22px"> 1. Defesa Estratégica: Industrialização na Origem
O Projeto **Mulheres Que Tecem a Floresta** propõe a quebra do paradigma extrativista tradicional, onde a agregação de valor ocorre majoritariamente em centros urbanos, distantes da floresta. Fundamentado nas pesquisas da Profa. Sonia Marise sobre bioeconomia indígena e extrativista, o projeto implementa agroindústrias comunitárias de baixo impacto para o beneficiamento de açaí e castanha-da-amazônia diretamente nos polos territoriais.

### <img src="../assets/patterns/square_03_black.svg" width="22px"> 1.1. Transição para a Bioeconomia da Sociobiodiversidade
A transição do modelo de "venda de matéria-prima in natura" para a "oferta de produtos processados" (castanha classificada e embalada, polpa de açaí pasteurizada) é o motor da autonomia financeira das comunidades. Este processo reduz a dependência de intermediários e garante que a maior fatia da receita permaneça na base produtiva, fortalecendo a economia local e incentivando a conservação da floresta em pé.

## <img src="../assets/patterns/square_04_black.svg" width="22px"> 2. Especificações Técnicas e Diferenciais
...
## <img src="../assets/patterns/square_08_black.svg" width="22px"> 3. Impacto Social e Redes de Cooperação
