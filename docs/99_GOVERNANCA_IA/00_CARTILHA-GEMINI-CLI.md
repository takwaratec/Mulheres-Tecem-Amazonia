## 📖 Cartilha de Uso: Gemini 2.5 no Terminal (Projeto WTF)
...
## 📜 2. Catálogo de Scripts: O que usar e quando?
...
## 📑 3. Extração de PDFs com Docling
...
## 🎯 4. Prompts Específicos para Documentos Isolados
...
## 🚀 5. Dicas de Produtividade com o Gemini CLI
...
**Deseja que eu prepare um comando do Docling que já direcione todos os PDFs da sua pasta de bibliografia direto para a quarentena, deixando o terreno pronto para o "Garimpo Digital"?** 🌿🌰
...
### 🏛️ Dica de Ouro: O Arquivo `.zshrc`
...
def transcrever_audio(caminho_audio, nome_arquivo):
    print(f"🎙️ Enviando para transcrição: {nome_arquivo}...")
...
def executar_transcricao_recursiva(diretorio_raiz):
    print(f"🚀 Iniciando varredura de áudios em: {diretorio_raiz}")
