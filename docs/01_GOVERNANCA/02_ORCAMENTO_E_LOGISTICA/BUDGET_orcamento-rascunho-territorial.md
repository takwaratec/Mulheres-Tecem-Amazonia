...
tipo: Rascunho Orçamentário (BUDGET)
referencia: BUDGET-TER-001-2026
status: Status Ready
author:
...
| :--- | :--- | :--- | :--- |
| **Obras e Instalações** | Construção do Galpão de Engenharia Leve e bases em Rio Branco. | 2.500.000,00 | 8,3% |
| **Logística e Mobilidade** | Aquisição de **1 Caminhão** e **1 Micro-ônibus** para manejo. | 2.000.000,00 | 6,7% |
| **Equipamentos de Base** | Máquinas de prateleira (serras, furadeiras, motosserras) e ferramentas. | 1.500.000,00 | 5,0% |
...
| Item | Descrição | Estimativa (R$) | % |
| :--- | :--- | :--- | :--- |
| **Kits de Bioeconomia** | Primeiros kits entregues (Reatores/Prensas). | 3.000.000,00 | 10,0% |
| **Equipamentos de Apoio** | Máquinas de processamento para castanha/artesanato e sacaria. | 1.000.000,00 | 3,3% |
...
| Item | Descrição | Estimativa (R$) | % |
| :--- | :--- | :--- | :--- |
| **Saneamento (BSM)** | Instalação de **20 módulos** e monitoramento sanitário. | 2.000.000,00 | 6,7% |
...
| Categoria | Descrição | Valor (R$) | % |
| :--- | :--- | :--- | :--- |
| **CAPEX (Infraestrutura)** | Obras, Veículos, Máquinas, Kits e BSM. | 15.000.000,00 | **50,0%** |
| **OPEX (Autonomia)** | Pessoas, Formação, Gestão, Mídia e Semente. | 15.000.000,00 | **50,0%** |
| **CAPEX RETORNADO** | Produtos internalizados (Móveis, Materiais). | **(Lucro de Base)** | **+ Excedente** |
| **CAPEX SANITÁRIO** | Economia em saúde (Redução de Doenças). | **(Valor Social)** | **- Custos SUS** |
| **TOTAL DO PROJETO** | **Mulheres Que Tecem a Floresta** | **30.000.000,00** | **100%** |
