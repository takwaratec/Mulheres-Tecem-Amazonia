...
**Análise:** O artigo discute a sustentabilidade e a durabilidade como pilares para a construção civil, focando em conceitos, desafios e estratégias. Ele aborda o ciclo de vida dos materiais, a geração de resíduos, o consumo de recursos e a importância do conhecimento para prolongar a vida útil das construções. Embora mencione materiais vegetais, o foco principal são os princípios gerais da construção sustentável e a durabilidade.
...
**(1) Dep. Civil Construction Eng., Escola Politécnica, Universidade de São Paulo, Ed. Eng. Civil, Cidade Universitária, São Paulo 05508 900 Brazil**
...
### 1.2 Aumentando a sustentabilidade da indústria

A sustentabilidade certamente implica em desvincular desenvolvimento de carga ambiental (Janssen; Van Der Bergh, 1999). A desmaterialização é uma ferramenta específica para esta dissociação, que consiste em obter o mesmo desempenho com menores quantidades de material, que por conseguinte representa uma redução de poluentes, incluindo a chuva ácida e a emissão de gases que causam o efeito estufa.

A desmaterialização pode ser feita também substituindo-se o modelo linear de produção no qual a matéria bruta é extraída da natureza, transformada industrialmente em produtos que são usados e, após o final do ciclo de vida são descartados. O novo paradigma da produção é chamado de ciclo fechado (Curwell & Cooper, 1998) ou modelo cíclico de produção (Craven et al., 1996). Neste modelo a utilização de todos os recursos empregados é otimizada e a geração de resíduos reduzida a um mínimo reciclável.
...
Esta confusão entre sustentabilidade e durabilidade faz sentido pois “uma forma de aumentar a produtividade dos recursos é aumentar a vida útil dos produtos” (DeSimone & Popoff, 1998).

Por outro lado, aumentando-se a durabilidade reduz-se também a quantidade de resíduos de construção e demolição.

### 1.4 Durabilidade, um atributo que depende do conhecimento
