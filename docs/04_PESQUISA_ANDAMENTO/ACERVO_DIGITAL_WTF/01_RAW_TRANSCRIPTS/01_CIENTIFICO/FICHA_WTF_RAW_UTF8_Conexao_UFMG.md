...
referencia: FICHA_WTF_RAW_UTF8_Conexao_UFMG.md
status: Em Revisão
author:
...
| :---------------------- | :--------------------- | :------ | :----------------------------------------- |
| Número da Patente       | PI 1002916-8 B1        |         | Patente de Invenção do INPI                |
| Data de Depósito        | 25/08/2010             |         |                                            |
| Data de Concessão       | 08/12/2020             |         |                                            |
| Classe Internacional    | F16B 7/00              |         | Elementos de conexão/fixação               |
| Titular                 | UFMG                   |         | Universidade Federal de Minas Gerais       |
| Inventor                | Luís Eustáquio Moreira |         |                                            |
| Material Principal      | Bambu                  |         | Utilizado para tubos estruturais           |
| Aplicações Principais   | Construção Civil       |         | Coberturas treliçadas, pórticos, passarelas |
| Aplicações Adicionais   | Móveis                 |         |                                            |
| Aplicações Adicionais   | Pequenos Veículos      |         | Bicicletas, andadores, cadeiras de roda    |
