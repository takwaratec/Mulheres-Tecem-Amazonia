...
| Tipo de Documento           | Patente (BR 10 2013 020788-8 A2)                        |
| Data de Depósito            | 15/08/2013                                              |
| Data de Publicação          | 14/07/2015 (RPI 2323)                                   |
| Titular(es)                 | UNIVERSIDADE ESTADUAL DE LONDRINA                       |
| Inventor(es)                | GILBERTO CARBONARI                                      |
| Int.CI.                     | A01N31/08; A01N65/20; A01N65/00; A01 P?/04; A01 P3/00 |
| CPC                         | A01N31/08; A01N65/20; A01N65/00                        |
| Preservativo utilizado      | Solução água+tanino                                     |
| Proporção Tanino na solução | 0,5% em peso (50g de Tanino em pó para 10L de água)     |
| Pressão de tratamento       | -13.8 N/cm² (~-1.38 bar ou ~-20 psi)                    |
| Tempo de tratamento         | 3 a 24 horas (para varas de ~3 metros de comprimento)   |
| Material a ser tratado      | Colmos (varas) de bambu                                 |
| Agentes inibidos            | Carunchos e fungos                                      |

**Coordenadas geográficas:**
Não foram encontradas coordenadas geográficas específicas no texto.
