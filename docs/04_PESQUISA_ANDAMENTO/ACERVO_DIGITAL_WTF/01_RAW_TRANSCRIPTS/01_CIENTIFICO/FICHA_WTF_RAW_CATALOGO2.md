...
referencia: FICHA_WTF_RAW_CATALOGO2.md
status: Em Revisão
author:
...
referencia: PES-TEC-2197-2026
status: Ready

REFERÊNCIA BIBLIOGRÁFICA (ABNT):
TAKWARA, Fabio. Catálogo: acervo técnico e de advocacy da Tecnologia Takwara para a Plataforma Amazônia Regenerativa. 2026. Zenodo. DOI: 10.5281/zenodo.18827106.
...
| :---------------- | :----------------------------------------------------------------------------- | :-------------------------------------- |
| Título do Catálogo | Nome principal do documento.                                                   | Catalogo                                |
| Série             | Série à qual o catálogo pertence.                                              | Acervo Takwara                          |
| Versão            | Versão atual do catálogo.                                                      | 2.0 / 2.1                               |
| Data de Publicação | Data de registro/publicação do catálogo.                                       | 2026-03-04                              |
| Autor Principal   | Autor responsável pelos documentos originais no acervo.                        | Fabio Takwara                           |
| Licença           | Tipo de licença de uso do conteúdo.                                            | CC BY 4.0                               |
| DOI               | Identificador Digital de Objeto do catálogo no Zenodo.                         | 10.5281/zenodo.18827106                 |
| Status            | Status da versão.                                                              | V2.0 (Advocacy 5.1)                     |
| Documentos PDF Citados | Número de documentos PDF listados na bibliografia do catálogo.                 | 81                                      |

**Coordenadas Geográficas:**
O fragmento de texto fornecido não contém coordenadas geográficas explícitas.
