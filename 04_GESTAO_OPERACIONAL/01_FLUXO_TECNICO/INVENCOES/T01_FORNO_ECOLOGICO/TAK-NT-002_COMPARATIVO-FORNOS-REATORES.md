...
tipo: Nota Técnica (NT-002)
referencia: TAK-NT-002-2026
...
| :--- | :--- | :--- | :--- |
| **Ignição** | Rocket Stove / Riser Vertical | Fornos Basais Simples | Ignição rápida e tiragem forçada. |
| **Materiais** | Inox 304/316 (Acid-Resistance) | Aço Carbono / Alvenaria | Durabilidade superior contra ácido (pH 2.5). |
| **Circularidade** | Reuso de gases (Metano/H2) | Geralmente apenas Carbonização | Ciclo fechado autotérmico. |
| **Integração** | Cascateamento (Pirólise + Vapor) | Foco apenas em Carvão/EP | Usina de tratamento completa. |

## 2. Incrementos de Engenharia (Modelo 5.1)
