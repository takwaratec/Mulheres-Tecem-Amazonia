...
license: CC BY 4.0
translations:
  pt: TAK_memorando-orcamentario.md
version: '2.2.2'
---
# Tak Memorando-Orcamentario
...
[![🇧🇷 PT](https://img.shields.io/badge/🇧🇷-Português-green)](./TAK_memorando-orcamentario.md)
...
Núcleo Institucional – Universidade de Brasília (UnB)  

Título: Política de Acesso Digital e Compartilhamento da Documentação  
Tipo de documento: Nota Técnica Interna  
Data: 03 de março de 2026  
Autor responsável: Institucional, Fabio Resck (Núcleo Institucional/UnB)  
...
Versão 2.1 – 03 mar. 2026 | Master DOI: [10.5281/zenodo.18827106](https://doi.org/10.5281/zenodo.18827106)[^1][^2]
...
- A contrapartida potencial (horas técnicas, documentos já produzidos com DOI, protótipos Jesiel/Institucional, comodato de área/galpão, apoio Imperveg, UFAC/Embrapa, viagens e Fase 0 Domo Voador) está descrita qualitativamente, mas ainda não consolidada como pacote quantitativo (R\$) fechado.[^4][^1]
...
- Valorizar em R\$ os ativos de contrapartida:
    ...
    - Horas técnicas já realizadas (UnB, Núcleo Institucional, UFAC, Embrapa, Imperveg, Jesiel).[^2][^1]
...
Este memorando pode ser anexado como “Nota Técnica de Consolidação Orçamentária” ao dossiê interno da UnB, servindo como checklist operacional das pendências a equacionar antes da submissão formal ao BNDES/Fundo Amazônia.
...
E-mail: Institucionaltec@gmail.com 
