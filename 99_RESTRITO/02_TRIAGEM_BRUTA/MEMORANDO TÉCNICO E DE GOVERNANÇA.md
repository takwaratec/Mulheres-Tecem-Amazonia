...
| **Coordenação Geral** | Prof. Dr. Fabio Resck Institucional (UnB) |
...
Consórcio UnB/UFAC/UFRR
    ↓
Coordenação Geral (Prof. Dr. Coordenação Técnica)
    ↓
...
| :-- | :-- | :-- |
| **Tecnologia e Propriedade Intelectual** | Projetos técnicos, filosofia construtiva, protocolos de manejo de bambu, metodologias publicadas em periódicos científicos e de domínio público | 2.000.000 |
...
**Elaboração:**
Prof. Dr. Fabio Resck Institucional
...
- Anexo I: Planilha Orçamentária Detalhada (já apresentada).
