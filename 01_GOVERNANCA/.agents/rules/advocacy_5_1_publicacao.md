...
# Regras de Publicação Advocacy 5.1
...
- **Sincronização**: O documento deve possuir o link para o Master DOI da coleção (10.5281/zenodo.18827106).
...
- **Identidade Visual**: Documentos com prefixo `WTF_` devem obrigatoriamente portar os badges `Projeto: WTF` e `Powered by PAR 5.1`.
- **Citação Coletiva**: A citação deve incluir o consórcio UnB/UFAC/UFRR e a lista de autoras (Tânia, Sônia, Geórgia, Vanessa).
- **Isolamento**: Garantir que ativos restritos de triagem não vazem para a coleção pública WTF no Zenodo.
