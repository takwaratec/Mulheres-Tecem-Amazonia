...
5. **Contexto Rede Pessoal**: Carregar e interpretar históricos em `/docs/99_RESTRITO/01_REDE_PESSOAL/` para manter a prontidão em comunicações informais e íntimas, aplicando sempre a correção ortográfica automática.
