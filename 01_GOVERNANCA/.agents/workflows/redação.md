...
2. **Padrão Advocacy WTF**: Aplique rigorosamente as regras em `.agents/rules/advocacy_5_1_redacao.md`.
3. **Higiene de Ativos**:
...
// turbo
**Comando Sugerido**: "Aplique o protocolo de redação técnica e Advocacy WTF ao arquivo [caminho] focando em [tema]."
