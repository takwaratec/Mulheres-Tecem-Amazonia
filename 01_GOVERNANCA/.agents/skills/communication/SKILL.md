...
Esta Skill orienta a transformação de conteúdo técnico em materiais de comunicação para redes sociais (@takwaratec), podcasts e mídia popular.
...
- Produção baseada em ferramentas de IA (NotebookLM, Gemini) para eficiência.
- Transformação de .md técnicos em roteiros, posts e deepdives em áudio.
