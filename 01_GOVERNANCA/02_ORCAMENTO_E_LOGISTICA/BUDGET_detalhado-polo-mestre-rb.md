...
## 1. Núcleo Takwara (Hub Rio Branco) - O Canteiro-Escola
...
| Rubrica | Item | Valor Líquido (R$) | Nota Fiscal/Fiscalización |
| :--- | :--- | :--- | :--- |
| **Infra** | Galpão Canteiro-Escola | R$ 1.200.000 | Reforma do Polo Mestre (RB) |
| **Machinery** | Portfólio Industrial (T01-T09) | R$ 4.500.000 | 12 invenções completas |
...
| Rubrica | Item | Valor Líquido (R$) | Responsabilidade |
| :--- | :--- | :--- | :--- |
| **Polos** | 5 Domos-Fábricas (T11) | R$ 4.000.000 | Sônia/Georgia/Tânia |
| **Castanha** | Agroindústrias Sônia Marise | R$ 3.500.000 | Cadeia Açaí/Castanha |
| **Logística** | Balsa T10 + Frotas 4x4 | R$ 1.400.000 | Gestão Tânia Cruz |
| **Saneamento** | Lote 100x T12 (BSM/BER) | R$ 600.000 | Gestão Georgia (MRV) |
...
| Rubrica | Item | Valor Líquido (R$) | Qtd |
| :--- | :--- | :--- | :--- |
...
| Item | % sobre Bruto | Valor Provisionado (R$) |
| :--- | :--- | :--- |
| **Taxa Adm (Fundação NIT)** | 10% | R$ 3.000.000 |
...
1.  **Diretor de P&D** (Takwara)
2.  **Engenheiro de Processos** (Jesiel)
3.  **Coordenador de Canteiro** (Filemon)
4.  **Supervisor Administrativo** (UnB)
5.  **8 Agentes ALICoop** (Distribuição Territorial)
6.  **2 Mestres Navais** (Construção T10)

Todas as remunerações estão provisionadas nas rubricas de OPEX (1.0M Takwara + 1.0M Campo).

---
**🎋 Núcleo Takwara — Engenharia de Soberania**
